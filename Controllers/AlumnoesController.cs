...
namespace Systema_Registro_Matricula.Controllers
{
    public class AlumnoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id_Alumno,Nombre,Apellido,Telefono,Correo,Direccion")] Alumno alumno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_Alumno,Nombre,Apellido,Telefono,Correo,Direccion")] Alumno alumno)
        {
            if (ModelState.IsValid)
            {
