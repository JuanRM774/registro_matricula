...
namespace Systema_Registro_Matricula.Controllers
{
    public class ProfesorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id_Profesor,Nombre,Apellido,Telefono,Correo,Direccion")] Profesor profesor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_Profesor,Nombre,Apellido,Telefono,Correo,Direccion")] Profesor profesor)
        {
            if (ModelState.IsValid)
            {
